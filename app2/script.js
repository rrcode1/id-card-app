...
// ---- Stable ID for this card (created once, reused every save) ----
function getCardId() {
...
function wireImageUpload(areaEl, inputEl, previewEl, placeholderEl, onSaved) {
...
wireImageUpload(photoArea, photoInput, photoPreview, photoPlaceholder, () => {});
...
bannerAreaEdit.addEventListener('click', () => bannerInput.click());
...
// ---- Barcode / extra image (Additional Details) ----
...
wireImageUpload(barcodeArea, barcodeInput, barcodePreview, barcodePlaceholder, () => {});
...
wireImageUpload(extraImageArea, extraImageInput, extraImagePreview, extraImagePlaceholder, () => {});

// ---- Signature pad (edit mode) ----
...
// ---- Populate the VIEW page from saved data ----
